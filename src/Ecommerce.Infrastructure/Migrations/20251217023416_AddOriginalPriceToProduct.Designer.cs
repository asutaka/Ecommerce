...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    [Migration("20251217023416_AddOriginalPriceToProduct")]
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 17, 2, 34, 16, 79, DateTimeKind.Utc).AddTicks(8505),
                            Email = "admin@ecommerce.com",
                            FullName = "Administrator",
                            IsActive = true,
                            PasswordHash = "$2a$11$sjNcsYCxJWJLBpTgFgu7buRsJ8WKwIAvALpTKCH5OijpYSCn1OcHu",
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 34, 16, 79, DateTimeKind.Utc).AddTicks(8514),
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("022cde36-e007-40d0-b193-568b64fbcfeb"),
                            Code = "GIAM40K",
                            CreatedAt = new DateTime(2025, 12, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            Description = "Giảm 40.000đ cho đơn hàng từ 500.000đ",
                            DiscountAmount = 40000m,
                            EndDate = new DateTime(2026, 1, 16, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            IsActive = true,
                            MinimumOrderAmount = 500000m,
                            StartDate = new DateTime(2025, 12, 10, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            UsageLimit = 100,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("e828027e-3812-4fdf-9fe4-7f225f14ccea"),
                            Code = "GIAM50K",
                            CreatedAt = new DateTime(2025, 12, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            Description = "Giảm 50.000đ cho đơn hàng từ 800.000đ",
                            DiscountAmount = 50000m,
                            EndDate = new DateTime(2026, 1, 31, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            IsActive = true,
                            MinimumOrderAmount = 800000m,
                            StartDate = new DateTime(2025, 12, 12, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            UsageLimit = 50,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("cb32debd-52c4-4f72-b01f-0cde100a1308"),
                            Code = "GIAM100K",
                            CreatedAt = new DateTime(2025, 12, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            Description = "Giảm 100.000đ cho đơn hàng từ 1.500.000đ",
                            DiscountAmount = 100000m,
                            EndDate = new DateTime(2026, 2, 15, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            IsActive = true,
                            MinimumOrderAmount = 1500000m,
                            StartDate = new DateTime(2025, 12, 14, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            UsageLimit = 30,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("bf7d14ae-ddcf-49f7-9443-6dd81a941fa8"),
                            Code = "FREESHIP",
                            CreatedAt = new DateTime(2025, 12, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            Description = "Miễn phí vận chuyển cho đơn hàng từ 300.000đ",
                            DiscountAmount = 30000m,
                            EndDate = new DateTime(2026, 3, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            IsActive = true,
                            MinimumOrderAmount = 300000m,
                            StartDate = new DateTime(2025, 12, 7, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 34, 15, 859, DateTimeKind.Utc).AddTicks(9734),
                            UsageLimit = 200,
                            UsedCount = 0
                        });

...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    [Migration("20251216083243_AddMultipleImagesToVariants")]
    partial class AddMultipleImagesToVariants
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 215, DateTimeKind.Utc).AddTicks(7614),
                            Email = "admin@ecommerce.com",
                            FullName = "Administrator",
                            IsActive = true,
                            PasswordHash = "$2a$11$RlbrW6.lmTAqbkWKm8I.UO9e4HOOZGrxnAJTMoADlEipWt4XyT6HG",
                            UpdatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 215, DateTimeKind.Utc).AddTicks(7624),
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd61ef7d-b271-4e73-9e7f-00b9b7df2503"),
                            Code = "GIAM40K",
                            CreatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            Description = "Giảm 40.000đ cho đơn hàng từ 500.000đ",
                            DiscountAmount = 40000m,
                            EndDate = new DateTime(2026, 1, 15, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            IsActive = true,
                            MinimumOrderAmount = 500000m,
                            StartDate = new DateTime(2025, 12, 9, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            UpdatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            UsageLimit = 100,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("8868080f-e9da-4f8e-a5cf-99c70f99c997"),
                            Code = "GIAM50K",
                            CreatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            Description = "Giảm 50.000đ cho đơn hàng từ 800.000đ",
                            DiscountAmount = 50000m,
                            EndDate = new DateTime(2026, 1, 30, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            IsActive = true,
                            MinimumOrderAmount = 800000m,
                            StartDate = new DateTime(2025, 12, 11, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            UpdatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            UsageLimit = 50,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("128f9dd2-6143-405c-8496-73ba5ccf5094"),
                            Code = "GIAM100K",
                            CreatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            Description = "Giảm 100.000đ cho đơn hàng từ 1.500.000đ",
                            DiscountAmount = 100000m,
                            EndDate = new DateTime(2026, 2, 14, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            IsActive = true,
                            MinimumOrderAmount = 1500000m,
                            StartDate = new DateTime(2025, 12, 13, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            UpdatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            UsageLimit = 30,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("7375c68f-c51e-4e14-9e02-8850cdf7db32"),
                            Code = "FREESHIP",
                            CreatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            Description = "Miễn phí vận chuyển cho đơn hàng từ 300.000đ",
                            DiscountAmount = 30000m,
                            EndDate = new DateTime(2026, 3, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            IsActive = true,
                            MinimumOrderAmount = 300000m,
                            StartDate = new DateTime(2025, 12, 6, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            UpdatedAt = new DateTime(2025, 12, 16, 8, 32, 43, 84, DateTimeKind.Utc).AddTicks(8813),
                            UsageLimit = 200,
                            UsedCount = 0
                        });

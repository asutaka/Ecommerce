...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    [Migration("20251217021857_AddOriginalPriceToVariant")]
    partial class AddOriginalPriceToVariant
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 986, DateTimeKind.Utc).AddTicks(3304),
                            Email = "admin@ecommerce.com",
                            FullName = "Administrator",
                            IsActive = true,
                            PasswordHash = "$2a$11$5iElwsCjog7S0bw5wSd59Oywiatu0n/JL9rfnZeKWbbFJ5hAYNxdq",
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 986, DateTimeKind.Utc).AddTicks(3310),
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f0a93eee-1445-49ec-a090-a7a3f7f122b2"),
                            Code = "GIAM40K",
                            CreatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            Description = "Giảm 40.000đ cho đơn hàng từ 500.000đ",
                            DiscountAmount = 40000m,
                            EndDate = new DateTime(2026, 1, 16, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            IsActive = true,
                            MinimumOrderAmount = 500000m,
                            StartDate = new DateTime(2025, 12, 10, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            UsageLimit = 100,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("ad4577e3-eecc-4059-b8b1-7aa4575be3f6"),
                            Code = "GIAM50K",
                            CreatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            Description = "Giảm 50.000đ cho đơn hàng từ 800.000đ",
                            DiscountAmount = 50000m,
                            EndDate = new DateTime(2026, 1, 31, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            IsActive = true,
                            MinimumOrderAmount = 800000m,
                            StartDate = new DateTime(2025, 12, 12, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            UsageLimit = 50,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("a4b06e4f-ebf4-4092-bd99-613af5e01179"),
                            Code = "GIAM100K",
                            CreatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            Description = "Giảm 100.000đ cho đơn hàng từ 1.500.000đ",
                            DiscountAmount = 100000m,
                            EndDate = new DateTime(2026, 2, 15, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            IsActive = true,
                            MinimumOrderAmount = 1500000m,
                            StartDate = new DateTime(2025, 12, 14, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            UsageLimit = 30,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("80a61722-4dce-47c6-acb7-cb1a357e6214"),
                            Code = "FREESHIP",
                            CreatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            Description = "Miễn phí vận chuyển cho đơn hàng từ 300.000đ",
                            DiscountAmount = 30000m,
                            EndDate = new DateTime(2026, 3, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            IsActive = true,
                            MinimumOrderAmount = 300000m,
                            StartDate = new DateTime(2025, 12, 7, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            UpdatedAt = new DateTime(2025, 12, 17, 2, 18, 56, 753, DateTimeKind.Utc).AddTicks(8490),
                            UsageLimit = 200,
                            UsedCount = 0
                        });

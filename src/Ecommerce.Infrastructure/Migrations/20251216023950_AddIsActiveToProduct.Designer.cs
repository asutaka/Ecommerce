...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    [Migration("20251216023950_AddIsActiveToProduct")]
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 143, DateTimeKind.Utc).AddTicks(969),
                            Email = "admin@ecommerce.com",
                            FullName = "Administrator",
                            IsActive = true,
                            PasswordHash = "$2a$11$dBIWw0JH.g5OwSz2lT7FfObSKTMP8f9At0syk4q2aTTwND0Ksvz1q",
                            UpdatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 143, DateTimeKind.Utc).AddTicks(974),
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9fc186d9-4fb8-41f2-be86-99c9553af9eb"),
                            Code = "GIAM40K",
                            CreatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            Description = "Giảm 40.000đ cho đơn hàng từ 500.000đ",
                            DiscountAmount = 40000m,
                            EndDate = new DateTime(2026, 1, 15, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            IsActive = true,
                            MinimumOrderAmount = 500000m,
                            StartDate = new DateTime(2025, 12, 9, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            UpdatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            UsageLimit = 100,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("fd4dd3e0-7e26-40f0-9bc2-dd764fe8576a"),
                            Code = "GIAM50K",
                            CreatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            Description = "Giảm 50.000đ cho đơn hàng từ 800.000đ",
                            DiscountAmount = 50000m,
                            EndDate = new DateTime(2026, 1, 30, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            IsActive = true,
                            MinimumOrderAmount = 800000m,
                            StartDate = new DateTime(2025, 12, 11, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            UpdatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            UsageLimit = 50,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("9016006d-9d59-4cde-b13e-57864e5cca3f"),
                            Code = "GIAM100K",
                            CreatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            Description = "Giảm 100.000đ cho đơn hàng từ 1.500.000đ",
                            DiscountAmount = 100000m,
                            EndDate = new DateTime(2026, 2, 14, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            IsActive = true,
                            MinimumOrderAmount = 1500000m,
                            StartDate = new DateTime(2025, 12, 13, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            UpdatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            UsageLimit = 30,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("c47835e4-d735-4967-8b22-df6f69db7608"),
                            Code = "FREESHIP",
                            CreatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            Description = "Miễn phí vận chuyển cho đơn hàng từ 300.000đ",
                            DiscountAmount = 30000m,
                            EndDate = new DateTime(2026, 3, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            IsActive = true,
                            MinimumOrderAmount = 300000m,
                            StartDate = new DateTime(2025, 12, 6, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            UpdatedAt = new DateTime(2025, 12, 16, 2, 39, 50, 12, DateTimeKind.Utc).AddTicks(7587),
                            UsageLimit = 200,
                            UsedCount = 0
                        });

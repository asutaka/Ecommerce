...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    [Migration("20251216035124_AddPriorityToCategory")]
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 738, DateTimeKind.Utc).AddTicks(9467),
                            Email = "admin@ecommerce.com",
                            FullName = "Administrator",
                            IsActive = true,
                            PasswordHash = "$2a$11$AmfhFSNT1aiST6520yCXwe/i8nHoj9PIrvMM.PNC9n7eGzpyJo6g6",
                            UpdatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 738, DateTimeKind.Utc).AddTicks(9473),
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Ecommerce.Infrastructure.Entities.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fd5707ea-ee7e-4ca3-9045-b9da8b4b7a33"),
                            Code = "GIAM40K",
                            CreatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            Description = "Giảm 40.000đ cho đơn hàng từ 500.000đ",
                            DiscountAmount = 40000m,
                            EndDate = new DateTime(2026, 1, 15, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            IsActive = true,
                            MinimumOrderAmount = 500000m,
                            StartDate = new DateTime(2025, 12, 9, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            UpdatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            UsageLimit = 100,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("35c5149f-43a0-4e08-887b-6f30542e4d73"),
                            Code = "GIAM50K",
                            CreatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            Description = "Giảm 50.000đ cho đơn hàng từ 800.000đ",
                            DiscountAmount = 50000m,
                            EndDate = new DateTime(2026, 1, 30, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            IsActive = true,
                            MinimumOrderAmount = 800000m,
                            StartDate = new DateTime(2025, 12, 11, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            UpdatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            UsageLimit = 50,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("d1775cdd-7194-4b7d-bd6c-42a3c50f5f07"),
                            Code = "GIAM100K",
                            CreatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            Description = "Giảm 100.000đ cho đơn hàng từ 1.500.000đ",
                            DiscountAmount = 100000m,
                            EndDate = new DateTime(2026, 2, 14, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            IsActive = true,
                            MinimumOrderAmount = 1500000m,
                            StartDate = new DateTime(2025, 12, 13, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            UpdatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            UsageLimit = 30,
                            UsedCount = 0
                        },
                        new
                        {
                            Id = new Guid("5a67c42e-cbef-4aa1-baf1-bae168590101"),
                            Code = "FREESHIP",
                            CreatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            Description = "Miễn phí vận chuyển cho đơn hàng từ 300.000đ",
                            DiscountAmount = 30000m,
                            EndDate = new DateTime(2026, 3, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            IsActive = true,
                            MinimumOrderAmount = 300000m,
                            StartDate = new DateTime(2025, 12, 6, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            UpdatedAt = new DateTime(2025, 12, 16, 3, 51, 23, 512, DateTimeKind.Utc).AddTicks(4589),
                            UsageLimit = 200,
                            UsedCount = 0
                        });
